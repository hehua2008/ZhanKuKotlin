...
class ButtonGroupRecyclerView @JvmOverloads constructor(
    ...
    private class SavedState : AbsSavedState {
        ...
        var checkedItemIdList: List<Long>? = null
    ...
    private fun isChildChecked(child: View): Boolean {
        ...
        return if (holder != null) {
            mCheckedItemIdSet.contains(holder.itemId)
        } else false
    }
    ...
    private fun dispatchOnButtonChecked(buttonItemId: Long, checked: Boolean) {
        val holder = findViewHolderForItemId(buttonItemId)
        if (holder != null) {
            dispatchOnButtonChecked(holder.layoutPosition, checked)
        }
    }
    ...
    private object MaterialButtonHelper {
        ...
        fun removeAllOnCheckedChangeListeners(button: MaterialButton?): Set<MaterialButton.OnCheckedChangeListener> {
        ...
        init {
            ...
            try {
                field = MaterialButton::class.java.getDeclaredField("onCheckedChangeListeners")
    ...
    companion object {
        private val LOG_TAG = ButtonGroupRecyclerView::class.java.simpleName
